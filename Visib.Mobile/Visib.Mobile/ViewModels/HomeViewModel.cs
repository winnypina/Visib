...
namespace Visib.Mobile.ViewModels
{
    public class HomeViewModel : MvxNavigationViewModel
    {
        ...
        public HomeViewModel(IMvxLogProvider logProvider, IMvxNavigationService navigationService, IPostService postService, ILoginService loginService) : base(logProvider, navigationService)
        {
        ...
        public MvxAsyncCommand<PostModel> ShareCommand => new MvxAsyncCommand<PostModel>(async (post) =>
        {
            ...
            {
                Title = "Visib",
                Subject = "Confira este vídeo feito com o Visib",
                Text = post.Title,
                Uri = post.VideoSource
            });
        });
